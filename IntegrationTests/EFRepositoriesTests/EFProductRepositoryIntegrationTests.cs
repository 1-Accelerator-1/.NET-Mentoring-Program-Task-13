...
namespace IntegrationTests.EFRepositoriesTests
{
    internal class EFProductRepositoryIntegrationTests : TestBase
    {
        [SetUp]
        public void SetUp()
        {
        ...
        public async Task Create_WhenProductIsNotNull_ShouldReturnProductsListWithNewProduct()
        {
            ...
            var productRepository = new EFProductRepository(orderManagmentDbContext);
